...
if __name__ == "__main__":
    ...
    input_csv_file = "data/without/without1.csv"       # Replace with your input CSV filename.
    output_csv_file = "data/without/without2.csv"  # The new CSV file with removed columns.
